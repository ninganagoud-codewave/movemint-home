    ...
    <div className="flex flex-col gap-y-8 ">
      <div className="flex justify-center w-full flex-col">
        <div className='flex justify-center w-full'>
          <p className="font-jost font-semibold text-heading text-center text-light_blue text-responsive text-heading">FAQs</p> 
          <p className="font-jost font-semibold text-heading text-center text-light_blue text-responsive text-heading"> - </p> 
